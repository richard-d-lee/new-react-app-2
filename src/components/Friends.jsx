...
const Friends = () => {
    ...
    const handleConfirm = async (friendId) => {
        try {
            ...
            fetchFriendsData();
            // Dispatch a custom event so that SuggestedFriends can re-fetch /possible-friends
    ...
    // Decline inbound friend request (new)
    const handleDecline = async (friendId) => {
        try {
            ...
            fetchFriendsData();
            // Dispatch an event so that suggested friends refresh immediately
            window.dispatchEvent(new Event('refreshPossibleFriends'));
        } catch (err) {
